...
replay, and explicit allowlist normalization. Other fault families, the
benchmark framework, and presentation are not implemented. Recovery Phase 5
adds the narrow Unit Drift scale-corruption, local detection, exact scoring,
...
scoring/replay, and controlled growth-ranking sensitivity.
"""
